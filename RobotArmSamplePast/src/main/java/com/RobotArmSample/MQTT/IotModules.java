...
////button////
    ...
    static String watchingClient_getRequest = "userM/line1/watchingClient/get/request";
...
//    static public  boolean WatchingClientGetRequest(String message)throws Exception {
//        myClient.publish(watchingClient_setRequest,new MqttMessage(message.getBytes()) );
//        for(int i = 0; i < 10; i++){
//            myCallback.pastMessageClear();
//           // myClient.publish(robotArmKuka_setStatus,new MqttMessage(("OK").getBytes()));
